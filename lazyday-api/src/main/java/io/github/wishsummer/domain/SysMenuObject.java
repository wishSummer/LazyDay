...
* @TableName sys_menu
*/
public class SysMenuObject implements Serializable {
    ...
    * 是否为外链（0是 1否）
    */
    private void setIsFrame(Integer isFrame){
    ...
    * 是否缓存（0缓存 1不缓存）
    */
    private void setIsCache(Integer isCache){
